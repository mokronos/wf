 ...
 *  package is built independently of the wfkit package. */
 ...
 *  `| undefined`. Request bodies here are built from optional form fields, so
 *  Schema.Json alone is too narrow. */
